...
class MagribScreen extends StatefulWidget {
  ...
  @override
  State<MagribScreen> createState() => _MaghribScreenState();
}

class _MaghribScreenState extends State<MagribScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text("Maghrib Prayer")),
      ),
      body: ValueListenableBuilder<Box<NotesModel>>(
        valueListenable: Boxes.getData().listenable(),
        builder: (context, box, _) {
          var data =
              box.values.where((note) => note.title == 'Maghrib').toList();

          if (data.isEmpty) {
            return const Center(
              child: Text('No Maghrib prayers available.'),
            );
          }
  ...
  Future<void> _editDialog(NotesModel note) async {
    ...
    await showDialog(
      ...
      builder: (context) {
        ...
        return AlertDialog(
          title: const Text("Edit Maghrib Prayer Details"),
          content: Column(
    ...
    await showDialog(
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              title: const Text("Add Maghrib Prayer Details"),
              content: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  DropdownButton(
