...
class ZohrScreen extends StatefulWidget {
  const ZohrScreen({super.key});

  @override
  State<ZohrScreen> createState() => _ZohrScreenState();
}

class _ZohrScreenState extends State<ZohrScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text("Zohr Prayer")),
      ),
      body: ValueListenableBuilder<Box<NotesModel>>(
        valueListenable: Boxes.getData().listenable(),
        builder: (context, box, _) {
          var data = box.values.where((note) => note.title == 'Zohr').toList();

          if (data.isEmpty) {
            return const Center(
              child: Text('No Zohr prayers available.'),
            );
          }
  ...
  Future<void> _editDialog(NotesModel note) async {
    ...
    await showDialog(
      ...
      builder: (context) {
        ...
        return AlertDialog(
          title: const Text("Edit Zohr Prayer Details"),
          content: Column(
    ...
    await showDialog(
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              title: const Text("Add Zohr Prayer Details"),
              content: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  DropdownButton(
